...
public class PictureData {
    ...
    @JSONField(name = Config.TEMPERPATH)
    private String temperPath;

    @JSONField(name = Config.PERSONPATH)
    private String personPath;

    @JSONField(name = Config.LoactionX1)
    private String x1;

    @JSONField(name = Config.LoactionX2)
    private String x2;

    @JSONField(name = Config.LoactionX3)
    private String x3;

    @JSONField(name = Config.LoactionX4)
    private String x4;

    @JSONField(name = Config.LoactionY1)
    private String y1;

    @JSONField(name = Config.LoactionY2)
    private String y2;

    @JSONField(name = Config.LoactionY3)
    private String y3;

    @JSONField(name = Config.LoactionY4)
    private String y4;
